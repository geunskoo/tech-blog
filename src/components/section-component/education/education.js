  ...
  return (
    <div className="education-wrapper">
      ...
      <div className="education-card-container">
        <h4 className="education-card-title">🎓 학교</h4>
